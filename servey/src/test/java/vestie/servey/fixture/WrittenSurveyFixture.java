...
import vestie.servey.domain.writtensurvey.service.dto.ChoiceQuestionAnswerDto;
import vestie.servey.domain.writtensurvey.service.dto.SubjectiveQuestionAnswerDto;
...
public class WrittenSurveyFixture {
	...
	public static WrittenSurveyDto writtenSurveyDto() {
		...
		for (int i = 0; i < 10; i++) {
			choiceQuestionAnswerDtos.add(choiceQuestionAnswerDto(5L * i, 5L * i + 1, 5L * i + 2, 5L * i + 3, 5L * i + 4));
