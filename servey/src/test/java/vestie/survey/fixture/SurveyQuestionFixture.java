...
public class SurveyQuestionFixture {
	...
	private final static Long QUESTION_ORDER = 1L;
	...
	public static SurveyQuestion surveyField(String title, Long questionOrder) {
		return new SubjectiveQuestion(title, questionOrder, ESSAY);
	}
	...
	public static ChoiceQuestionRequest choiceQuestionRequest(Long ... ids) {
		...
		return new ChoiceQuestionRequest(TITLE, QUESTION_ORDER, IS_MULTI_SELECTABLE,choiceOptionRequests);
	}

	public static SubjectiveQuestionRequest subjectiveQuestionRequest() {
		return new SubjectiveQuestionRequest(TITLE, QUESTION_ORDER, SUBJECTIVE_TYPE.toString());
	}
}
